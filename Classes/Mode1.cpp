...
USING_NS_CC;
Scene* Mode1::createScene()
{
	//create scene
	auto scene = Scene::create();

	//create layer
	auto layer = Mode1::create();
...
bool Mode1::init()
{
	...
	listener->onKeyPressed = CC_CALLBACK_2(Mode1::onKeyPressed, this);
	listener->onKeyReleased = CC_CALLBACK_2(Mode1::onKeyReleased, this);
...
void Mode1::spriteSheet()
{
	//create sprite
	auto background = Sprite::create("mode1-background.png");
...
void Mode1::createButton()
{
	//create item for home, undo, reset

	auto home = MenuItemImage::create("home.png", "home.png", CC_CALLBACK_1(Mode1::goToMenu, this));
	auto undo = MenuItemImage::create("undo.png", "undo.png", CC_CALLBACK_1(Mode1::undo, this));
	auto reset = MenuItemImage::create("reset.png", "reset.png", CC_CALLBACK_1(Mode1::reset, this));
...
void Mode1::onKeyPressed(EventKeyboard::KeyCode keyCode, Event *pevent)
{
	//up 28
	//down 29
	//left 26
...
void Mode1::onKeyReleased(EventKeyboard::KeyCode keyCode, Event *pevent)
{

}
void Mode1::Swap(int &a, int &b)
{
	int temp = a;
	a = b;
	b = temp;
...
void Mode1::update(float dt)
{
	...
	if (checkGameOver() == true)
	{
		...
		//create item
		auto playAgainItem = MenuItemImage::create("play-again.png", "play-again.png", CC_CALLBACK_1(Mode1::reset, this));
		auto exitItem = MenuItemImage::create("exit.png", "exit.png", CC_CALLBACK_1(Mode1::Exit, this));
...
void Mode1::goToMenu(Ref *sender)
{
	auto scene = MainMenuScene::createScene();
	Director::getInstance()->replaceScene(TransitionFade::create(TRANSITION_TIME, scene));
}
void Mode1::undo(Ref *sender)
{
	//board[4][4] = list[4][4][size - 1];
	//size--;
}
void Mode1::reset(Ref *sender)
{
	auto scene = Mode1::createScene();
	Director::getInstance()->replaceScene(TransitionFade::create(0.5, scene));
}
void Mode1::Exit(Ref *sender)
{
